...
missingChar("kitten", 4) → "kittn"
    ...
    public String missingChar(String str, int n) {
        String fr = str.substring(0, n);
        String bk = str.substring(n+1, str.length());
        return fr.concat(bk);
    }
...
in3050(40, 50) → true
    ...
    public boolean in3050(int a, int b) {
        boolean aR = (a >= 30 && a <= 40);
        boolean aR2 = (a >= 40 && a <= 50);
        boolean bR = (b >= 30 && b <= 40);
        boolean bR2 = (b>= 40 && b <= 50);

        return (aR && bR) || (aR2 && bR2);
    }
